...
angular.module('streama.translations').config(function ($translateProvider) {
  $translateProvider.translations('en', {
    ...
    DASHBOARD: {
      ...
      DISCOVER_SHOWS: 'Discover Groups',
      DISCOVER_MOVIES: 'Discover Videos',
      ...
      NO_TVSHOWS_FOUND: 'No Groups Available',
      NO_WATCHLIST_FOUND: 'Nothing here',
      NO_MOVIES_FOUND: 'No Videos Available',
      WATCHLIST: 'Watchlist'
    },
    VIDEO: {
      RELEASED: 'Released',
